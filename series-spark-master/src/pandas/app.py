...
# read files
get_device = ps.read_json("/Users/luisfarias/GitHub/series-spark/docs/files/device/*.json")
get_subscription = ps.read_json("/Users/luisfarias/GitHub/series-spark/docs/files/subscription/*.json")
