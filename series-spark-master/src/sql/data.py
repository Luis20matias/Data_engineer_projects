...
spark.sql("""
    ...
    OPTIONS (path "/Users/luisfarias/GitHub/series-spark/docs/files/device/*.json")
""")

spark.sql("""
CREATE TEMPORARY VIEW vw_subscription
USING org.apache.spark.sql.json
OPTIONS (path "/Users/luisfarias/GitHub/series-spark/docs/files/subscription/*.json")
""")
